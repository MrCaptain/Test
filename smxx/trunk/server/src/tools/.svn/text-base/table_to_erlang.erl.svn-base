...
-define(TABLES, [
		 ...
		 {temp_item_equipment, temp_item_equipment, tpl_equipment, [1]},
		 {temp_item_gem,  temp_item_gem, tpl_item_gem,  [1]} ,
		 {temp_item_suit, temp_item_suit, tpl_item_suit, [1,2]} ,
		 {temp_mon_layout, temp_mon_layout, data_scene_mon, [1]} ,
		 %{temp_notice,temp_notice, []} ,
		 %{temp_npc,temp_npc, []} ,
		 {temp_npc_layout,temp_npc_layout, tpl_npc_layout, [1,2]},
         {temp_skill,temp_skill, tpl_skill, [1]},
         {temp_skill_attr,temp_skill_attr, tpl_skill_attr, [1,2]} ,
		 {temp_scene,temp_scene, tpl_scene,[1]} ,
		 {temp_task,tpl_task, tpl_task,[1]} ,
 		 {task_detail,task_detail, task_detail,[1]} ,
		 ...
		 {temp_suit_reward,temp_suit_reward,tpl_suit_reward,[1]},
