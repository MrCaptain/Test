...
set_player_info_fields(Player, [H|T]) ->	
	NewPlayer =	
		case H of	
				...
				{pet_template_id, Val, add} -> Player#player{other=Player#player.other#player_other{pet_template_id = Player#player.other#player_other.pet_template_id + Val}};	
				{pet_template_id, Val, sub} -> Player#player{other=Player#player.other#player_other{pet_template_id = Player#player.other#player_other.pet_template_id - Val}};	
				{pet_template_id, Val, _} -> Player#player{other=Player#player.other#player_other{pet_template_id =  Val}};	
				{pet_template_id, Val} -> Player#player{other=Player#player.other#player_other{pet_template_id =  Val}};	
				{pet_nick, Val, add} -> Player#player{other=Player#player.other#player_other{pet_nick = Player#player.other#player_other.pet_nick + Val}};	
...
get_table_fields(Table_name) ->	
	Table_fileds = [ 	
		...
		{goods,[{id, 0},{uid, 0},{pet_id, 0},{gtid, 0},{location, 0},{cell, 0},{num, 0},{score, 0},{hole, 0},{hole_goods, []},{polish_num, 0},{stren_lv, 0},{stren_percent, 0},{type, 0},{subtype, 0},{quality, 0},{sell_price, 0},{career, 0},{gender, 0},{level, 0},{max_num, 0},{bind, 0},{expire_time, 0},{suit_id, 0},{gilding_lv, 0},{goods_cd, 0}]},	
		...
		{goods_to_buff,[{gtid, 0},{buff_id, 0}]},	
		{guild,[{id, 0},{name, []},{chief_id, 0},{chief_name, []},{announce, []},{level, 0},{current_num, 0},{elite_num, 0},{devo, 0},{fund, 0},{upgrade_time, 0},{create_time, 0},{maintain_time, 0},{state, 0},{accuse_id, 0},{accuse_time, 0},{against, 0},{agree, 0},{accuse_num, 0}]},	
		...
		{temp_bones,[{lv, 0},{bones_val, 0}]},	
		{temp_buff,[{buff_id, 0},{name, [230,157,130,230,138,128]},{type, 0},{group, 0},{priority, 0},{last_time, 0},{times, 0},{ratio, 10000},{link_skill, []},{overlay, 0},{max_num, 0},{data, []}]},	
		...
		{temp_goods,[{gtid, 0},{name, []},{icon, 0},{fall, 0},{type, 0},{subtype, 0},{quality, 0},{sell_price, 0},{career, 0},{gender, 0},{level, 0},{max_num, 0},{limit, 0},{expire_time, 0},{suit_id, 0},{cd, 0},{desc, []}]},	
		{temp_goods_buff,[{gtid, 0},{buff_tid, 0}]},	
		{temp_item_equipment,[{gtid, 0},{appearance, 0},{set_id, 0},{max_stren, 0},{equip_attr, []},{stren_change, []},{max_holes, 0},{max_gilding, 0}]},	
		...
		{temp_task,[{tid, 0},{type, 0},{start_npc, 0},{start_scene, 0},{end_npc, 0},{end_scene, 0},{target_type, 0},{target_property, "0"},{name, []},{desc, []},{ongoing_dialog, "\"\""},{finish_dialog, []},{pre_tid, 0},{level, 0},{career, 0},{gender, 0},{guild, 0},{team, 0},{goods_list, []},{guild_goods_list, []},{func_num, 0},{next_tid, 0}]},	
