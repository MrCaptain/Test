...
read(40001,<<CurPageNo:8,TotalPage:8,BinData/binary>>) ->
    ...
    Fun_GuildList = fun(_Idx, {RestBin, ResultList}) ->
        ...
        {_Name_DoneBin, [[GuildId, GuildName, CurNum, MaxNum, Level, Uid, Name]|ResultList]}
    end,
...
%%Protocol: 40033 提升职务(帮主)
%%--------------------------------------
write(40033,[Uid,NewPos]) ->
    {ok, pt:pack(40033, <<Uid:64,NewPos:8>>)};
