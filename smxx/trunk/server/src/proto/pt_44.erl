...
write(44000,[StCode,Level,Star,Exp,Fashion,Riding,SkillList,FashionList]) ->
    ...
    {ok, pt:pack(44000, <<StCode:8,Level:8,Star:8,Exp:32,Fashion:8,Riding:8,SkillList_ABinData/binary,FashionList_ABinData/binary>>)};
...
%%Protocol: 44006 升星
%%--------------------------------------
write(44006,[Result,NewStar]) ->
    {ok, pt:pack(44006, <<Result:8,NewStar:8>>)};
