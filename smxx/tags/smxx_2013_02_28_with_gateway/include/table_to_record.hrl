...
-record(player, {	
      ...
      camp = 0,                               %% 阵营(国籍)	
      lilian = 0,                             %% 历练值	
      mount_flag = 0,                         %% 座骑标志位0无座骑，1:有座骑并使用 2:有座骑不使用	
...
-record(goods, {	
      ...
      bind = 0,                               %% 限制条件，绑定状态，0为不可绑定，1为可绑定2已绑定,	
...
-record(temp_npc, {	
      ...
      drop_id = 0,                            %% 掉落物品ID(temp_drop_main.did)	
