...
%% 广播到其它节点的部落频道
broadcast_to_camp([], _Realm, _Data) -> ok;
broadcast_to_camp([H | T], Realm, Data) ->
    rpc:cast(H#server.node, lib_send, send_to_local_camp, [Realm, Data]),
    broadcast_to_camp(T, Realm, Data).
